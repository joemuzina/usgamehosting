// US Game Hosting
// Homepage Media Splash jQuery Handler
// Updated 5/6/2020
// Joe Muzina
// joe.muzina@gmail.com

var COLLAPSED = false;
var WELCOME_DELAY = 1440; // desired interval between user being welcomed, 1440 minutes = once a day
var isMobile = false;
...
function collapseAway() {
    ...
    if (!isMobile) $("#splash-collapse").fadeOut(400);
